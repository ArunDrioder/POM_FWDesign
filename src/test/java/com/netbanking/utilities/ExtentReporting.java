...
public static String reportPath = "C:\\Backup\\Selenium - Workspace\\IdeaProjects\\POM_FWDesign\\test-output\\"+"New Automation Report";
...
public void onStart(ITestContext testContext)
{
	...
	new File(actualReportPath).renameTo(new File(
			"C:\\Backup\\Selenium - Workspace\\IdeaProjects\\POM_FWDesign\\test-output\\"+ "Automation_" + filePathdate + ".html"));
